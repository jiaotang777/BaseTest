...
function nodeQualityMarkup(value, extraClass = "") {
  ...
  for (const rawLine of lines) {
    ...
    if (isNodeQualityTitleLine(rawLine)) {
      flushBody();

      pieces.push(
        `<div class="nq-report-title">${ansiToHtml(
...
function reportPage(report) {
  ...
  return pageShell(`
    ...
    <script src="/assets/report.js?v=0419" defer></script>
  `, "BaseTest Report");
}
