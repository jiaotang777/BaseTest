...
function sectionMarkup(
  ...
  return `
    ...
    >
      ...
      <pre class="report-output${content ? "" : " empty-output"}">${content ? ansiReportToHtml(content) : ""}</pre>
...
function reportPage(report) {
  ...
  return pageShell(`
    ...
    <script src="/assets/report.js?v=0414" defer></script>
  `, "BaseTest Report");
}
